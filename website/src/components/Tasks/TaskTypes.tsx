...
export const TaskInfos: TaskInfo[] = [
  // general/random
  {
    ...
    help_link: "https://projects.open.models.platform/open-models-iecho/docs/guides/guidelines",
  ...
  // create
  {
    ...
    help_link: "https://projects.open.models.platform/open-models-iecho/docs/tasks/reply_as_user",
  ...
  },
  {
    ...
    help_link: "https://projects.open.models.platform/open-models-iecho/docs/tasks/reply_as_assistant",
  ...
  // evaluate
  {
    ...
    help_link: "https://projects.open.models.platform/open-models-iecho/docs/guides/guidelines#user-reply",
  ...
  },
  {
    ...
    help_link: "https://projects.open.models.platform/open-models-iecho/docs/tasks/rank_assistant_replies",
  ...
  // label (full)
  {
    ...
    help_link: "https://projects.open.models.platform/open-models-iecho/docs/tasks/label_prompter_reply",
  ...
  },
  {
    ...
    help_link: "https://projects.open.models.platform/open-models-iecho/docs/tasks/label_assistant_reply",
