...
# worker image name
image_name="ghcr.io/open-models-platform/open-models-iecho/oasst-inference-worker-$image_type:$image_tag"

# get visible gpu env variable, default to all
gpus=${CUDA_VISIBLE_DEVICES:-0,1,2,3,4,5,6,7}
api_key=${API_KEY:-0000}
backend_url=${BACKEND_URL:-wss://inference.prod2.open-models-iecho.io}
